...
@section('page_subtitle', 'Edit evaluation for {{ $placement->user?->name }}')
...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <form method="POST" action="{{ route('evaluations.update', [$placement, $evaluation]) }}" class="divide-y divide-gray-200">
                @csrf
